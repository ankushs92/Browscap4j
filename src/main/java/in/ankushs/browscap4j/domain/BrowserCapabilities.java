...
public final class BrowserCapabilities {
    ...
    public static class Builder {
        ...
        private String deviceCodeName = "Unknown";
        private String deviceBrandName = "Unknown";
        private String platform = "Unknown";
        private String platformMaker = "Unknown";
    ...
    public boolean isWindows() {
        ...
        // This is rather a crude way of doing it and is done on the basis of
        // observation of how browscap resolves windows user agents.
        return getPlatform().contains("Win");
    }

    @Override
    public String toString() {
        return "BrowserCapabilities{" + "browser='" + browser + '\'' + ", deviceName='" + deviceName + '\''
                + ", browserType='" + browserType + '\'' + ", deviceType='" + deviceType + '\'' + ", deviceCodeName='"
                + deviceCodeName + '\'' + ", deviceBrandName='" + deviceBrandName + '\'' + ", platform='" + platform
                + '\'' + ", platformMaker='" + platformMaker + '\'' + ", platformVersion='" + platformVersion + '\''
    ...
    public boolean equals(Object o) {
        ...
        if (isMobile != that.isMobile)
            return false;
        if (isTablet != that.isTablet)
            return false;
        if (!browser.equals(that.browser))
            return false;
        if (!deviceName.equals(that.deviceName))
            return false;
        if (!browserType.equals(that.browserType))
            return false;
        if (!deviceType.equals(that.deviceType))
            return false;
        if (!deviceCodeName.equals(that.deviceCodeName))
            return false;
        if (!deviceBrandName.equals(that.deviceBrandName))
            return false;
        if (!platform.equals(that.platform))
            return false;
        if (!platformMaker.equals(that.platformMaker))
            return false;
